...
<html>
	...
	href="<%=request.getContextPath()%>/design/images/DQI-icon.png">
       ...
       <div class="content-page">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL%>updateStatePost/${sid} " enctype="multipart/form-data" autocomplete="off">
                                <div class="form-group col-md-12">
                                <input type="hidden" id="stateid" value="${sid}">
                                    <label for="state_name">State Name<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" onkeyup="exist(this.value)" value="${state_name}" id="state_name" name="state_name" placeholder="Enter state name" data-parsley-pattern="^[a-zA-Z ]+$"  data-parsley-maxlength="100">
                                ...
                                <div class="form-group text-right m-b-0">
                                    <button class="btn btn-gradient waves-effect waves-light btnsubmit" type="submit">
                                     ...
                                     <a href="<%=dashboardURL%>state"><button type="button" class="btn btn-light waves-effect m-l-5">
                                        Cancel
                                    </button></a>
    ...
    <!-- state existeor not -->
      ...
      function exist(name){
    	  var stateid=$("#stateid").val();
      	 $.ajax({
               url: "<%=dashboardURL%>getStateExistanceByid",
               type: "GET", 
