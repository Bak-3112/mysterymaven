...
display: none;
       ...
       <div class="content-page">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="addSection"  autocomplete="off">
                                <div class="form-group col-md-12">
                                    <label for="state_name">Section Name<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" onkeyup="exist(this.value)" id="section_name" name="section_name" placeholder="Enter Section Name" data-parsley-pattern="^[a-zA-Z ]+$"  data-parsley-maxlength="100">
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <tr>
                                    ...
                                    <td><a href="<%=dashboardURL%>editSection/${dbBean.sk_section_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="#"  class="fa fa-trash" data-id="${dbBean.sk_section_id}" data-toggle="modal" data-target="#myModal"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                <c:forEach var="dbBean" items="${inactiveSectionList}">
                                <tr>
                                    <td>${dbBean.section_name }</td>
                                    <td><a href="#" data-restoreid="${dbBean.sk_section_id}" data-toggle="modal" data-target="#myModal1" title="Restore the State" class="mdi mdi-backup-restore"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
        ...
        <script type="text/javascript">
            ...
            $(".fa-trash").on("click",function(){
            	...
            	var url="<%=dashboardURL%>deleteSection/"+value;
            	$(".btn-edit").attr("href",url);
            });
            
            $(".mdi-backup-restore").on("click",function(){
            	var value=$(this).attr("data-restoreid");
            	var url="<%=dashboardURL%>restoreSection/"+value;
	...
	jQuery('#section_name').keyup(function() 
	{
		var str = jQuery('#section_name').val();
		var spart = str.split(" ");
      ...
      jQuery('#section_name').val(spart.join(" "));
        ...
        $(".btnsubmit").on("click",function(){
        	  $('form').parsley();
          	if($("#sectionerrormsg").text()=="Section is  already exist ...!"){
          		 $("#testbox").prop('required',true);
          		 setTimeout(function(){
             			var id=$("#testbox").attr("data-parsley-id");
             			  $("#parsley-id-"+id+"").hide();
             		}, 10);
          	}else	if($("#sectionerrormsg").text()=="Section is in Inactive tab ,Please restore ...!"){
          		 $("#testbox").prop('required',true);
          		 setTimeout(function(){
             			var id=$("#testbox").attr("data-parsley-id");
             			  $("#parsley-id-"+id+"").hide();
      ...
      <!-- state existeor not -->
        <script type="text/javascript">
        function exist(section_name){
        	 $.ajax({
                 url: "<%=dashboardURL%>getsectionExistance",
                 type: "GET", 
                 ...
                 success: function(response)
               	 ...
               	 var statusmessage=response.status;
					   if(msg=="sectionexist" && statusmessage=="active"){
						   $("#sectionerrormsg").text("Section is  already exist ...!")
					   }else if(msg=="sectionexist" && statusmessage=="inactive"){
						   $("#sectionerrormsg").text("Section is in Inactive tab ,Please restore ...!")
					   }else{
					var id=$("#testbox").attr("data-parsley-id");
