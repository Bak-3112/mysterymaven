       ...
       <div class="content-page">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL%>createModelPost" enctype="multipart/form-data" autocomplete="off">
                            <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required class="form-control"  onkeyup="exist(this.value)" id="model_name" name="model_name" placeholder="Enter Model Name"   data-parsley-maxlength="100">
                     ...
                     <div class="col-md-6">
                        <div class="card-box table-responsive">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <tbody>
                                <c:forEach var="uBean" items="${modelList}">
                                <tr>
                                    <td>${uBean.brand_name }</td>
                                    <td>${uBean.model_name }</td>
                                    <td><a href="<%=dashboardURL%>editModel/${uBean.sk_model_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="#"  class="fa fa-trash" data-id="${uBean.sk_model_id}" data-toggle="modal" data-target="#myModal"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                <c:forEach var="uBean" items="${inactivemodelList}">
                                <tr>
                                    <td>${uBean.brand_name }</td>
                                    <td>${uBean.model_name }</td>
                                    <td><a href="#" data-restoreid="${uBean.sk_model_id}" data-toggle="modal" data-target="#myModal1" title="Restore the State" class="mdi mdi-backup-restore"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
        ...
        <script type="text/javascript">
            ...
            $(".fa-trash").on("click",function(){
            	...
            	var url="<%=dashboardURL%>deleteModel/"+value;
            	$(".btn-edit").attr("href",url);
            });
            
            $(".mdi-backup-restore").on("click",function(){
            	var value=$(this).attr("data-restoreid");
            	var url="<%=dashboardURL%>restoreModel/"+value;
	...
	jQuery('#model_name').keyup(function() 
	{
      ...
      jQuery('#model_name').val(spart.join(" "));
        ...
        $(".btnsubmit").on("click",function(){
        	  $('form').parsley();
          	if($("#modelerrormsg").text()=="Model already exists...!"){
      ...
      <!-- state existeor not -->
        ...
        function exist(name){
        	var brand_id=$("#brand_id").val();
          	 $.ajax({
                   url: "<%=dashboardURL%>getModelExistance",
                   type: "GET", 
                   ...
                   success: function(response)
                 	...
                 	// alert(statusmessage)
   					   if(msg=="modelexist" && statusmessage=="active"){
   						   $("#modelerrormsg").text("Model already exists...!")
   					   }else if(msg=="modelexist" && statusmessage=="inactive"){
   						   $("#modelerrormsg").text("Model is in Inactive tab ,Please restore ...!")
   					   }else{
   					var id=$("#testbox").attr("data-parsley-id");
