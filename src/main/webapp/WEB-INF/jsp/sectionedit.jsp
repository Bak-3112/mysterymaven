       ...
       <div class="content-page">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL%>updateSection"  autocomplete="off">
                                <div class="form-group col-md-12">
                                    <label for="state_name">Section Name<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control" onkeyup="exist(this.value)" id="section_name" name="section_name" value="${sectionName}" placeholder="Enter Section Name" data-parsley-pattern="^[a-zA-Z ]+$"  data-parsley-maxlength="100">
                                     <input type="hidden"  class="form-control" id="sk_section_id" name="sk_section_id" value="${sectionId}" placeholder="Enter Section Name">
                                ...
                                <div class="form-group text-right m-b-0">
                                    ...
                                    <a href="<%=dashboardURL%>addSection"><button type="button" class="btn btn-light waves-effect m-l-5">
                                        Cancel
                                    </button></a>
	...
	jQuery('#section_name').keyup(function() 
	{
      ...
      jQuery('#section_name').val(spart.join(" "));
        ...
        $(".btnsubmit").on("click",function(){
        	  $('form').parsley();
          	if($("#sectionerrormsg").text()=="Section is  already exist in ...!"){
      ...
      <!-- state existeor not -->
        ...
        function exist(section_name){
        	 ...
        	 $.ajax({
                 url: "<%=dashboardURL%>getsectionExistanceById",
                 type: "GET", 
                   data: { 'section_name': section_name,'sk_section_id':sk_section_id  },
                 success: function(response)
               	...
               	// alert(statusmessage)
					   if(msg=="sectionexist" && statusmessage=="active"){
						   $("#sectionerrormsg").text("Section is  already exist in ...!")
