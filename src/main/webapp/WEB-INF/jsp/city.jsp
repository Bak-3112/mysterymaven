       ...
       <div class="content-page">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL%>createCityPost" enctype="multipart/form-data" autocomplete="off">
                                <div class="form-group col-md-12">
                                 ...
                                 <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required   class="form-control" onkeyup="exist(this.value)" id="city_name" name="city_name" placeholder="Enter City Name" data-parsley-pattern="^[a-zA-Z ]+$"  data-parsley-maxlength="100">
                    ...
                    <div class="col-md-6">
                        <div class="card-box table-responsive">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <tbody>
                                <c:forEach var="cBean" items="${activeCityList}">
                                <tr>
                                    <td>${cBean.state_name }</td>
                                      <td>${cBean.city_name }</td>
                                      <td>${cBean.tier }</td>
                                      <td>${cBean.metro }</td>
                                    <td><a href="<%=dashboardURL%>editCity/${cBean.sk_city_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="#"  class="fa fa-trash" data-id="${cBean.sk_city_id}" data-toggle="modal" data-target="#myModal"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                <c:forEach var="cBean" items="${inactiveCityList}">
                                <tr>
                                   <td>${cBean.state_name }</td>
                                      <td>${cBean.city_name }</td>
                                       <td>${cBean.tier }</td>
                                      <td>${cBean.metro }</td>
                                    <td><a href="#"  title="Restore the City" class="mdi mdi-backup-restore" data-restoreid="${cBean.sk_city_id}" data-toggle="modal" data-target="#myModal1"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
        ...
        <script type="text/javascript">
            ...
            $(".fa-trash").on("click",function(){
            	...
            	var url="<%=dashboardURL%>cityDelete/"+value;
            	$(".btn-edit").attr("href",url);
            })
             $(".mdi-backup-restore").on("click",function(){
            	var value=$(this).attr("data-restoreid");
            	var url="<%=dashboardURL%>restoreCity/"+value;
    ...
    <!-- state existeor not -->
      ...
      function exist(name){
    	  var state_id=$("#state_id").val();
      	 $.ajax({
               url: "<%=dashboardURL%>getCityExistance",
               type: "GET", 
