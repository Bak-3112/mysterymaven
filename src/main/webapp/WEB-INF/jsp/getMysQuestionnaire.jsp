...
<head>
<meta charset="utf-8" />
<title>Mystery-Mystery Questionnaire</title>
<meta name="viewport"
...
.custombox-modal-container-fadein {
	z-index: 10003;
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="page-title-box">
								<div class="btn-group pull-right">
									<ol class="breadcrumb hide-phone p-0 m-0">
										...
										<li class="breadcrumb-item"><a href="#">Mystery Shopper Submission</a></li>
									</ol>
								</div>
								<h4 class="page-title">Mystery Shopper Submission</h4>
							</div>
							<div class="row">
							<div class="col-sm-6">
							<a class="btn btn-light waves-effect m-l-5 Pull-left" href="<%=dashboardURL%>viewMysCompleted" style="margin: -21px -15px 10px 0;">Back</a>
														...
														<div class="col-sm-6">
							<a class="btn btn-gradient waves-effect waves-light pull-right" href="<%=dashboardURL%>editMysteryShopperLinkDetails/${sk_shopper_id}" style="margin: -21px -15px 10px 0;">Edit Shopper Details</a>
								</div>						</div>
						</div>
					</div>
					<div class="row">
							...
							<div class="card-box">
								...
								<ul class="nav nav-tabs">
									<li class="nav-item all"><a href="#home" data-toggle="tab"
										aria-expanded="false" class="nav-link active"> Mystery Shopper
											Submission  </a></li>
									<li class="nav-item sp"><a href="#sp" data-toggle="tab"
										aria-expanded="false" class="nav-link"> Quality Assurance
											 </a></li>
									<!-- <li class="nav-item review"><a href="#review"
								...
								<div class="tab-content">
									<div class="tab-pane fade show active" id="home">
										<form method="POST" action="<%=dashboardURL%>submitReview">
											<div class=" table-responsive">
											   ...
											   <input type= "hidden" id="sk_shopper_id"  name="sk_shopper_id" value="${sk_shopper_id }">
												...
												<table class="table table-striped table-bordered"
													...
													<tbody>
														<c:forEach var="mvBean" items="${mysQuestionstatus}">
															<tr>
															 ...
															 <c:choose>
                                                              <c:when test="${mvBean.formula_flag !='1'}">
																...
																<td><a href="<%=dashboardURL%>viewquestions/${mvBean.sk_shopper_id}/${mvBean.question_id}">Review</a><br></td>
															</tr>
															</c:forEach>
									...
									<!-- EXCEPTIONS -->
									<div class="tab-pane fade" id="sp"></div>
