...
.highlight1
{
  ...
  margin-left: 16px;
       ...
       <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Edit Weightage</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL%>updateWeightage" autocomplete="off">
                               <label class="highlight1">Weightage can not exceed value 1. Kindly revise it.<span class="highlight">(*)</span></label>
                                <div class="form-group col-md-12">
										...
										<input type="hidden" id="sk_id" name="sk_id" value="${sk_id}">
										<input type="hidden" id="sid"  value="${sk_section_id}">
										<input type="hidden" id="sname" value="${section_name}">
										<div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required class="form-control"  id="weightage" name="weightage"  placeholder="Enter Wieightage" value="${weightage}" data-parsley-pattern="^[0-9]*\.[0-9]{2}$" data-parsley-range="[0.01, 1]">
                                </div>
                                ...
                                <div class="form-group text-right m-b-0">
                                    ...
                                    <a href="<%=dashboardURL%>weightage"><button type="button" class="btn btn-light waves-effect m-l-5">
                                        Cancel
                                    </button></a>
   ...
   <script>
   $(document).ready(function() {
   var sid=$("#sid").val().split(",");
   var sname=$("#sname").val().split(",");
   for(var i=0;i<sname.length;i++){
   $("#section_id").prepend("<option value='"+sid[i]+"' selected>"+sname[i]+"</option>")
   }
   var optionValues =[];
