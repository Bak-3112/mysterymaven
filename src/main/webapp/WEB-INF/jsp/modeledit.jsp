...
<html>
       ...
       <div class="content-page">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL%>updateModelPost/${sid}" enctype="multipart/form-data" autocomplete="off">
                                <div class="form-group col-md-12">
                                 ...
                                 <input type="hidden" value="${sid}" id="model_id">
                                 <div class="form-group col-md-12">
                                    <label for="state_name">Model Name<span class="text-danger">*</span></label>
                                    <input type="text" required onkeyup="exist(this.value)"  class="form-control" id="model_name" name="model_name" value="${model_name}" placeholder="Enter model name"   data-parsley-maxlength="100">
                              <span id="modelerrormsg" style="color:red"></span>
                                ...
                                <div class="form-group text-right m-b-0">
                                   ...
                                   <a href="<%=dashboardURL%>model"><button type="button" class="btn btn-light waves-effect m-l-5">
                                        Cancel
                                    </button></a>
	...
	$("#sk_brand_id").on("change",function(){
        ...
        $(".btnsubmit").on("click",function(){
      	  $('form').parsley();
        	if($("#modelerrormsg").text()=="Model is  already exist ...!"){
    ...
    <!-- state existeor not -->
      ...
      function exist(name){
      	...
      	var model_id=$("#model_id").val();
        	 ...
        	 $.ajax({
                 url: "<%=dashboardURL%>getModelExistanceById",
                 type: "GET", 
                   data: { 'name': name,'brand_id':brand_id,'model_id':model_id },
                 success: function(response)
               	...
               	// alert(statusmessage)
 					   if(msg=="modelexist" && statusmessage=="active"){
 						   $("#modelerrormsg").text("Model is  already exist ...!")
