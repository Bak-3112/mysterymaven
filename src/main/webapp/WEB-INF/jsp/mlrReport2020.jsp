					...
					<div class=" container-fluid mt-3 mb-5">
						...
						<div class="row ">
							<div class="col-md-4 my-3">
								 ...
								 <h4 class="chart-title-heading text-center">Test Drive Offer</h4>  
								<div class="card">
									<div class="card-body">										
...
<script type="text/javascript">
 function save_chart23(chart) {
	...
	$("#canvasimg37").attr('src','data:image/svg+xml;base64,' + btoa(unescape(encodeURIComponent(svg))));
