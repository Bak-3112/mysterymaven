  ...
  <div class="content-page">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="addsubSection"  autocomplete="off">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required class="form-control" onkeyup="exist(this.value)" id="subsection_name" name="subsection_name" placeholder="Enter Sub Section Name" data-parsley-pattern="^[a-zA-Z ]+$"  data-parsley-maxlength="100">
                     ...
                     <div class="col-md-6">
                        <div class="card-box table-responsive">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <tr>
                                    <td>${dbBean.subsection_name }</td>
                                    <td>${dbBean.section_name }</td>
                                    <td><a href="<%=dashboardURL%>/editsubSection/${dbBean.sk_subsection_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="#"  class="fa fa-trash" data-id="${dbBean.sk_subsection_id}" data-toggle="modal" data-target="#myModal"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                <c:forEach var="dbBean" items="${inactiveSubsectionList}">
                                <tr>
                                    <td>${dbBean.subsection_name }</td>
                                    <td>${dbBean.section_name }</td>
                                    <td><a href="#" data-restoreid="${dbBean.sk_subsection_id}" data-toggle="modal" data-target="#myModal1" title="Restore the State" class="mdi mdi-backup-restore"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
	...
	jQuery('#subsection_name').keyup(function() 
	{
      ...
      <!-- state existeor not -->
        <script type="text/javascript">
        function exist(subsection_name){
        	var sk_section_id=$("#sk_section_id").val();
        	 $.ajax({
                 url: "<%=dashboardURL%>getSubsectionExistance",
                 type: "GET", 
                   data: { 'subsection_name': subsection_name,'sk_section_id': sk_section_id},
