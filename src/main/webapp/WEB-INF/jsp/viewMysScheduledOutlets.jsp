...
<html>
    <head>
        <meta charset="utf-8" />
        <title>MYS-View Mystery Outlets</title>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="<%=UI_PATH%>/resources/design/images/DQI-icon.png">
                    ...
                    <div class="col-md-12">
                         <div class="card-box">
                           ...
                           <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                <c:forEach var="uBean" items="${getShopperList}">
                                <tr> 
                                      <td>${uBean.dealer_name}</td>
                                      <td>${uBean.outlet_name}</td>                                    
                                      <td>${uBean.visit_date }</td>
                                      <td>${uBean.quarter }</td> 
                                      <td>${uBean.year}</td>
