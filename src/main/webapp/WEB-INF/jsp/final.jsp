	...
	<body class="bodysection">
        ...
        <header class="header clearfix">
            <div class="logo pull-left">
                ...
                <a>
                    <img src="<%=UI_PATH%>/design/images/mini.png" width="100"    alt="logo">
                </a>
               
            </div>
            <div class="greetingtext pull-right">
            	<span>Welcome <!-- Mystery Shopper  --><b>${visitor_name}</b></span>
            	<a href="<%=dashboardURL%>upload/${sid}"><img src="<%=UI_PATH%>/design/images/home.png" width="16" height="16"></a>
            </div>
        </header>
        <div class=" quizwrap quizwrap-adjst clearfix">
            <div class="col-xs-12 col-md-12   fig-wrap" >
              ...
              <div class="col-xs-12 col-md-12 pt-60 bg-white d-f fd-column jc-center form-wrap">
                  <h2 class="text-center"><b>Thank you for completing the questionnaire</b></h2>
                  <%-- <div class="button-wrap text-center">
                    <a href="<%=dashboardURL %>document/${sid}" class="btn btn-upload btn-block">
                        Upload documents
                    </a>
                    <span>Or</span>
                    <a href="<%=dashboardURL %>shopperDetails/${sid}" class="btn btn-upload btn-block">
