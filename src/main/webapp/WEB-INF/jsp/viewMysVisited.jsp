...
<html>
    <head>
        <meta charset="utf-8" />
        <title>MYS-View MYS VISITED</title>
    ...
    <div id="wrapper">
      ...
      <div class="content-page">
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Mystery Shopper Visited</a></li>
                                </ol>
                            </div>
                    ...
                    <div class="col-md-12">
                         <div class="card-box">
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item all">
                                         ...
                                         <li class="nav-item visited">
                                            <a href="#visited" data-toggle="tab" aria-expanded="true" class="nav-link active">
                                             Visited
                                            </a>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="visited">
                             ...
                             <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                 ...
                                 <tbody>
                               <c:forEach var="uBean" items="${mysVisitedList}">
                                <tr>
                                      ...
                                      <td>${uBean.shopper_question_count }</td>
                                    <td><a href="<%=dashboardURL%>editMysteryShopper/${uBean.sk_shopper_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="#" data-index="${uBean.sk_shopper_id}" class="fa fa-trash btn-delete"  data-target="#myModal" class="trigger-btn" data-toggle="modal"></a>
                                    <br><a href="<%=dashboardURL%>updatetoSchedule/${uBean.sk_shopper_id}" class="fa fa-times">&nbsp;Not Visited?</a><br><a href="<%=dashboardURL%>updatetoComplete/${uBean.sk_shopper_id}" class="fa fa-check">&nbsp;Completed?</a></td>
                                </tr>
                             </c:forEach>
                                </tbody> 
                            </table>
		...
		$(document).on('click','.btn-delete',function(e){
        	...
        	$('.btn-edit').attr('href','deleteMysteryShopper/'+user_id);
