                ...
                <div class="row" >
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b> </b></h4>
                             ...
                             <a href="<%=dashboardURL%>LowScoringOutletdownload" target="_blank" class="btn btn-secondary buttons-excel buttons-html5 download" style="margin-bottom: 13px;">Excel</a>
                            ...
                            <table id="datatable-buttons1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th>Outlet</th>
                                    <th>Date of Visit</th>
                                    <th>MYS Shopper Name</th>
                                    <th>MYS Contact Number</th>
                                    <th>MYS Email</th>
                                    <th>Name of Sales Consultant</th>
                                    <th>Outlet Score</th>
                                    <th width="70%">Lost Opportunities</th>
                                   
                                </tr>
                                </thead>
                                <tbody>
                                <c:forEach var="mvBean" items="${lowerScore}" varStatus="loop">
                                <tr>
...
var brand_id=$('#brand_id').val();
 function getIds(){
    ...
    var mode=$('#mode').val();
    $.ajax({
          url: "<%=dashboardURL%>getlowscoringcountIds",
          type: "GET", 
...
$('.Next').on('click', function(){
	...
	window.location.href ="/LowScoringOutlet/"+report_type+"/"+year+"/"+month+"/"+region_id+"/"+sk_dealer_id+"/"+sk_outlet_id+"/"+brand_id+"/"+i;
...
var sheet = xlsx.xl.worksheets['sheet1.xml'];
 ...
 <script>
        $(".download").click(function(){
        	...
        	var sk_dealer_id= $("#sk_dealer_id").val();
        	var sk_outlet_id= $("#sk_outlet_id").val();
        	$(this).attr('href','<%=dashboardURL%>LowScoringOutletdownload/'+year+'/'+month+'/'+region_id+'/'+sk_dealer_id+'/'+sk_outlet_id+'/'+brand_id+'');
        });
