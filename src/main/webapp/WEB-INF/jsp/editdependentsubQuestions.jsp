		...
		<div class="content-page">
			...
			<div class="content">
				...
				<c:forEach var="dbBean" items="${sectionList}">
				 ...
				 <c:forEach var="qBeans" items="${qBean.optionsList}"><option value="${qBeans.sk_answer_id }" <c:forEach var="qBeans1" items="${qBean.selectedoptionsList}"><c:if test = "${qBeans.sk_answer_id == qBeans1.sk_answer_id }">selected </c:if> </c:forEach>>${qBeans.answer }</option></c:forEach></select><div id="chke"></div>
 ...
 --%>        <script src="<%=UI_PATH%>/plugins/autoNumeric/autoNumeric.js" type="text/javascript"></script>
	...
	<script>
        ...
        $(add_button).on("click",function(e){
        	  var x=$(".subquestiontype_list3").find(".sub_otpions ").length-1;
