       ...
       <div class="content-page">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-box ">
                            ...
                            <form method="POST" action="<%=dashboardURL%>createVarientPost" enctype="multipart/form-data" autocomplete="off">
                            
                                 <div class="form-group col-md-12">
                                    <label for="state_name">Brand Name<span class="text-danger">*</span></label>
									<select id="brand_id" name="brand_id" required class="form-control" onchange="getModels(this.value);" >
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required class="form-control"  onkeyup="exist(this.value)" id="varient_name" name="varient_name" placeholder="Enter Varient Name"   data-parsley-maxlength="100">
                     ...
                     <div class="col-md-6">
                        <div class="card-box table-responsive">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <tbody>
                                <c:forEach var="uBean" items="${varientlList}">
                                <tr>
                                    <td>${uBean.brand_name }</td>
                                     <td>${uBean.model_name }</td>
                                    <td>${uBean.varient_name }</td>
                                    <td><a href="<%=dashboardURL%>/editVariant/${uBean.sk_varient_id}" class="fa fa-edit"></a>&nbsp;&nbsp;&nbsp;<a href="#"  class="fa fa-trash" data-id="${uBean.sk_varient_id}" data-toggle="modal" data-target="#myModal"></a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                <c:forEach var="uBean" items="${inactivevarientList}">
                                <tr>
                                    <td>${uBean.brand_name }</td>
                                     <td>${uBean.model_name }</td>
                                    <td>${uBean.varient_name }</td>
                                    <td><a href="#" data-restoreid="${uBean.sk_varient_id}" data-toggle="modal" data-target="#myModal1" title="Restore the Variant" class="mdi mdi-backup-restore"></a></td> 
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
        ...
        <script type="text/javascript">
            ...
            $(".fa-trash").on("click",function(){
            	...
            	var url="<%=dashboardURL%>deleteVarient/"+value;
            	$(".btn-edit").attr("href",url);
            });
            
            $(".mdi-backup-restore").on("click",function(){
            	var value=$(this).attr("data-restoreid");
            	var url="<%=dashboardURL%>restoreVarient/"+value;
      ...
      <!-- state existeor not -->
        ...
        function exist(name){
        	var model_id=$("#model_id").val();
         	 $.ajax({
                  url: "<%=dashboardURL%>getVariantExistance",
                  type: "GET", 
