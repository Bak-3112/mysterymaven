...
public class MysteryShoppingVisitsController {
	...
	public ModelAndView addscheduleMysteryShopper(HttpServletRequest request, HttpServletResponse response,
		 ...
		 * System.out.println("encrypted"+encrypted_shopper_id); } catch (Exception e) {
	...
	public ModelAndView viewMysCompleted(HttpServletRequest request, HttpServletResponse response,MysteryShoppingVisitsBean mvBean) {
	...
	public ModelAndView viewDocuments(@PathVariable String sk_shopper_id,MysteryShoppingVisitsBean mvBean,HttpServletRequest request, HttpServletResponse response) {
	...
	public ModelAndView getMysQuestionnaire(@PathVariable String sk_shopper_id, MysteryShoppingVisitsBean mvBean,
		...
		//String visit_day = LocalDate.parse(datee).getDayOfWeek().getDisplayName(TextStyle.FULL, Locale.US);
		request.setAttribute("sk_shopper_id", mvBean.getSk_shopper_id());
		request.setAttribute("name", mvBean.getName());
		request.setAttribute("shoppers_car_owned", mvBean.getShoppers_car_owned());
		request.setAttribute("shoppers_car_owned_brand", mvBean.getShoppers_car_owned_brand());
	...
	public ModelAndView editMysteryShopperDetails(@PathVariable String sk_shopper_id, MysteryShoppingVisitsBean mvBean,
		...
		request.setAttribute("dealer_id", mvBean.getDealer_id());
		request.setAttribute("brand_model_variant_id", mvBean.getVariant_id());
		//System.out.println("brandmodelvariant"+mvBean.getVariant_id());
		request.setAttribute("brand_name", mvBean.getBrand_name());
		request.setAttribute("model_name", mvBean.getModel_name());
		request.setAttribute("dealer_name", mvBean.getDealer_name());
		request.setAttribute("variant_name", mvBean.getVariant_name());
	...
	public ModelAndView submitReview(HttpServletRequest request, HttpServletResponse response,MysteryShoppingVisitsBean mBean,RedirectAttributes redirectAttributes) throws IOException {
		ModelAndView model = null;
	...
	public ModelAndView submitReview2(HttpServletRequest request, HttpServletResponse response,MysteryShoppingVisitsBean mBean) throws IOException {
		ModelAndView model = null;
		String sk_shopper_id = mBean.getSk_shopper_id();
		model = new ModelAndView("redirect:/getMysQuestionnaire/" + sk_shopper_id + "");
		HttpSession session = request.getSession(true);
	...
	public ModelAndView getMYSsecondphase(@PathVariable String sk_shopper_id,HttpServletRequest request, HttpServletResponse response, MysteryShoppingVisitsBean mvBean) throws ParseException {
		...
		request.setAttribute("type", mvBean.getType());
		request.setAttribute("visit_status", mvBean.getShopper_link_visit_date());
		List<MysteryShoppingVisitsBean> QualityAssuranceQuestionstatus = mvDao.getmysQuestionstatus(mvBean,sk_shopper_id);
		mv.addObject("QualityAssuranceQuestionstatus", QualityAssuranceQuestionstatus);
		return mv;
	}

	@RequestMapping("getMysScore/{sk_shopper_id}")
	public ModelAndView getMysScore( @PathVariable String sk_shopper_id,HttpServletRequest request, HttpServletResponse response, MysteryShoppingVisitsBean mvBean) throws ParseException {
	...
	public ModelAndView viewMysClosed(HttpServletRequest request, HttpServletResponse response,MysteryShoppingVisitsBean mvBean, DatabaseManagementBean dbBean) {
	...
	public ModelAndView viewMysPublished(HttpServletRequest request, HttpServletResponse response,MysteryShoppingVisitsBean mvBean,DatabaseManagementBean dbBean) throws IOException {
		ModelAndView mv = new ModelAndView("viewMysClosed");
		...
		request.setAttribute("year", mvBean.getYear());
		System.out.println("year in publish"+mvBean.getYear());
		request.setAttribute("brand_id", mvBean.getBrand_id());
	...
	public ModelAndView document(@PathVariable String sid, HttpServletRequest request, HttpServletResponse response,
	  ...
	  @RequestMapping(value = "/saveDocument", method = RequestMethod.POST) public
	  ModelAndView addDocument( @ModelAttribute("multipleFileUploadForm") MultipleFileUploadForm multipleFileUploadForm, HttpServletRequest request, HttpServletResponse response, HttpSession session ,MysteryShoppingVisitsBean mvBean,RedirectAttributes redirectAttributes) throws IllegalStateException, IOException { 
	  ModelAndView model = null; String
	  sk_shopper_id = mvBean.getSk_shopper_id(); 
	  ...
	  { 
	    file=""; 
				...
				// TODO: handle exception
				System.out.println("upload first exception"+e);
			}
	  }
	  } catch (Exception e) {
			// TODO: handle exception
			System.out.println("upload second exception"+e);
		}
	...
	public ModelAndView viewquestion(@PathVariable String sid, MysteryShoppingVisitsBean mBean,
		...
		String encrypted_shooper_id = sid;
		System.out.println(mBean.getShopper_link_productNameProvided()+"sdjkfhskjah");
		/*
		 * String decrypt_shooper_id = encrypted_shooper_id.replace("symbol", "/");
		 * String decrypted_shooper_id = AESCrypt.decrypt(decrypt_shooper_id);
		 */
	...
	public ModelAndView questionare(@PathVariable String sid, @PathVariable String limit,
		...
		List<MysteryShoppingVisitsBean> allquestionsList = mvDao.allquestionsList(mBean,mBean.getBrand_id(),mBean.getMode_of_contact(),limit,decrypted_shooper_id,mBean.getYear());
	...
	public ModelAndView answer(@PathVariable String sid, @PathVariable String limit, MysteryShoppingVisitsBean mBean,
		...
		HttpSession session = request.getSession(true);
		String user_id = (String) session.getAttribute("userId");
		System.out.println(mBean.getAnswer());
		List<MysteryShoppingVisitsBean> answerdata = mBean.getAnswerdata();
		 ...
		 }else  if(mBean.getQuestion_type().equals("Main Question With Set Of SubQuestions") || mBean.getQuestion_type().equals("Dependent Question With Set Of SubQuestions") ) {
	...
	public ModelAndView viewquestions(@PathVariable String sk_shopper_id,  @PathVariable String question_id ,HttpServletRequest request, HttpServletResponse response,
			MysteryShoppingVisitsBean mvBean) throws Exception {
		ModelAndView mv = new ModelAndView("reviewQuestions");
		...
		List<MysteryShoppingVisitsBean>questionAnswerlist = mvDao.reviewQuestionDetailsByQuestionId(mvBean, sk_shopper_id,question_id);
	  ...
	  public ModelAndView updateAnswer(HttpServletRequest request, HttpServletResponse response, MysteryShoppingVisitsBean mBean){
	  ModelAndView mv = null; 
	  HttpSession session = request.getSession(true);
	  String user_id = (String) session.getAttribute("userId");
	 System.out.println("user id in update answer"+user_id);
	 ...
	 List<MysteryShoppingVisitsBean> answerdata = mBean.getAnswerdata();
	  ...
	  {
	  System.out.println("subquestions in else"); 
	  try {
		  System.out.println("hi formula ");
	  mvDao.updateAnswerById(mBean,answerdata,user_id);
	  System.out.println("formula flag"+mBean.getFormula_flag());
	  String ff[]=mBean.getFormula_flag().split(",");
	  if(ff[0].contentEquals("1")) 
	  {
		  System.out.println("formula in if");
	...
	public ModelAndView publishtoClose(@PathVariable String shopper_id,HttpServletRequest request, HttpServletResponse response,
			MysteryShoppingVisitsBean mBean){
			ModelAndView mv = null;
	...
	public ModelAndView viewQualityAssurancequestions(@PathVariable String sk_shopper_id,  @PathVariable String question_id ,HttpServletRequest request, HttpServletResponse response,
		MysteryShoppingVisitsBean mvBean) throws Exception {
