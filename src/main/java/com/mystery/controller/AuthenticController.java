...
public ModelAndView signIn(HttpServletRequest request, HttpServletResponse response, UserBean uBean,RedirectAttributes redirectAttributes) {
...
public ModelAndView resetPassword(@PathVariable String userId, HttpServletRequest request,HttpServletResponse response){
ModelAndView mv=new ModelAndView("resetpassword");
		 ...
		 * System.out.println("encrypted country_id="+decrypt_userId); decrypted_userId
		 * = AESCrypt.decrypt(decrypt_userId); String userId1=decrypted_userId;
		 * System.out.println("decrypted country id="+decrypt_userId);
